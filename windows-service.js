...
const svc = new Service({
  ...
  script: path.join(__dirname, 'backend-node.js'),
  nodeOptions: [
...
svc.on('install', () => {
  ...
  console.log('   Remove:  node windows-service.js uninstall');
});
...
switch (command) {
  ...
  default:
    ...
    console.log('Usage: node windows-service.js [command]');
    console.log('');
    ...
    console.log('');
    console.log('For development, use: node backend-node.js');
    console.log('For production, use: node windows-service.js install');
    break;
}
